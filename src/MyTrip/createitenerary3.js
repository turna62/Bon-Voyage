        ...
        fetch("http://localhost:5000/newitinerary", {
          ...
          .then((data) => {
            ...
            if (data.status === "OK!") {
                ...
                window.location.href = `http://localhost:3000/myitinerary3?userId=${encodeURIComponent(this.state.userId)}&tripId=${encodeURIComponent(this.state.tripId)}&itineraryId=${data.itineraryId}`;
        ...
        fetch("http://localhost:5000/itinerary", {
          ...
          .then((data) => {
            ...
            if (data.status === "OK!") {
                ...
                //alert('submitted Successfully!');
                window.localStorage.setItem('itineraryId', data.itineraryId);
                //window.location.href = `http://localhost:3000/createitenerary4?userId=${encodeURIComponent(this.state.userId)}&tripId=${encodeURIComponent(this.state.tripId)}&itineraryId=${data.itineraryId}`;
